...
def generate_reg1(first4bits,lastbyte):
    string1 = str(bin(first4bits)[2:])
    ...
    for i in range(8):
        if i >= len_string2: 
            string2 = '0' + string2 
    # print(string1,string2)           
    reg1 = string1 + string2
    return reg1


def generate_reg2(first3bits,byte_2,byte_1):
    string0 = str(bin(first3bits)[2:])
